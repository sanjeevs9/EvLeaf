...
export default function Home(){
    return (
        ...
        <div className="bg-RED ">
            ...
            height="100%"  url="https://video.wixstatic.com/video/11062b_06ba851b8adf4d11816ea8b9bb9b5398/1080p/mp4/file.mp4" playing={true} muted={true}   loop={true} >
            ...
            {/* <div className="absolute  top-0 left-0  flex items-center justify-center w-full h-full  ">
                ...
                <div className="flex text-white text-sm gap-5 p-5">
